...
export const Food = () => {
  ...
  const foodList = useAppSelector(state => state.resto.food.entities);
  const loading = useAppSelector(state => state.resto.food.loading);
  const totalItems = useAppSelector(state => state.resto.food.totalItems);
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('foodSize')}>
                  Food Size <FontAwesomeIcon icon="sort" />
                </th>
                    ...
                    {food.image ? (
                      <div>
                        {food.imageContentType ? (
                          <a onClick={openFile(food.imageContentType, food.image)}>
                            <img src={`data:${food.imageContentType};base64,${food.image}`} style={{ maxHeight: '30px' }} />
                            &nbsp;
                          </a>
                        ) : null}
                        <span>
