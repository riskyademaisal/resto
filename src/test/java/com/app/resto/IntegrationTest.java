...
import com.app.resto.RestoApp;
import com.app.resto.config.AsyncSyncConfiguration;
import com.app.resto.config.EmbeddedSQL;
...
@SpringBootTest(classes = { RestoApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
