...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.app.resto.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.app.resto.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
